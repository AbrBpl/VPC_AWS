...
| <a name="output_database_subnet_az_mapping"></a> [database\_subnet\_az\_mapping](#output\_database\_subnet\_az\_mapping) | A mapping of database subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_elasticache_subnet_az_mapping"></a> [elasticache\_subnet\_az\_mapping](#output\_elasticache\_subnet\_az\_mapping) | A mapping of Elasticache subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_intra_subnet_az_mapping"></a> [intra\_subnet\_az\_mapping](#output\_intra\_subnet\_az\_mapping) | A mapping of intra subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_outpost_subnet_az_mapping"></a> [outpost\_subnet\_az\_mapping](#output\_outpost\_subnet\_az\_mapping) | A mapping of outpost subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_private_subnet_az_mapping"></a> [private\_subnet\_az\_mapping](#output\_private\_subnet\_az\_mapping) | A mapping of private subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_public_subnet_az_mapping"></a> [public\_subnet\_az\_mapping](#output\_public\_subnet\_az\_mapping) | A mapping of public subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
...
| <a name="output_redshift_subnet_az_mapping"></a> [redshift\_subnet\_az\_mapping](#output\_redshift\_subnet\_az\_mapping) | A mapping of Redshift subnet IDs to Availability Zones, useful when deploying PrivateLink endpoint services, which require matching AZs on both ends. |
